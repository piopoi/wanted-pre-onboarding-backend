...
public class RecruitControllerTest extends BaseControllerTest {
    ...
    void searchRecruit() throws Exception {
        ...
        addRecruit(1L, "백엔드 주니어", 10000L, "주니어 개발자를 채용합니다.", "Python, Java");
        addRecruit(2L, "개발자", 50000L, "프론트엔드 개발자를 환영합니다.", "React");
        addRecruit(4L, keyword + "백엔드 주니어 개발자", 1500000L, "백엔드 개발자를 채용합니다.", "Java");
